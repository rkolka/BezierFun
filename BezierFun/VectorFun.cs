...
public partial class Script
{
    ...
    /// <summary>
    /// Geometric product. (ab)use Vector2 for representing scalar, bivector/pseudoscalar pair
    /// </summary>
    /// <param name="a"></param>
    /// <param name="b"></param>
    /// <returns></returns>
    public static Complex Prod2(Vector2 a, Vector2 b) =>
        new Complex(
            a.X * b.X + a.Y * b.Y  // dot
            ,
            a.X * b.Y - a.Y * b.X  // wedge
        )
    ;

    public static Vector2 Prod2(Complex a, Vector2 b) =>
        v2(
            // a.U * b.e1 + a.e12 * b.e2 
            a.Real * (double)b.X + a.Imaginary * (double)b.Y
            ,
            // a.U * b.e2 + a.e12 * b.e1  
            a.Real * (double)b.Y - a.Imaginary * (double)b.X
        )
    ;

    public static Vector2 Prod2(Vector2 a, Complex b) =>
        v2(
            // a.e1 * b.U + a.e2 * b.e12 
            (double)a.X * b.Real - (double)a.Y * b.Imaginary
            ,
            // a.U * b.e2 + a.e1 * b.e12  
            (double)a.Y * b.Real + (double)a.X * b.Imaginary
        )
    ;


    /// <summary>
    /// Sign of the pseudoscalar
    /// </summary>
    /// <param name="a"></param>
    /// <param name="b"></param>
    /// <returns></returns>
    public static int Sign2(Vector2 a, Vector2 b) =>
        Math.Sign(Prod2(a, b).Imaginary)
    ;
